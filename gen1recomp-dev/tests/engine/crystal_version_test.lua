...
local LINEAGES = { gen1 = true, gs = true, crystal = true, gen3 = true }
for _, id in ipairs(GameVersion.ORDER) do
...
eq(GameVersion.ORDER[7], "ruby", "ruby is appended after crystal")
...
eq(cycle, #GameVersion.ORDER + 4,
  "the ring is the seven games plus mods/find/skins/bug")
