...
base=json.loads((R/'tools/baselines/8.1.66-runtime-sha256.json').read_text())['files']
allowed={
 'config.lua','lib/CelestialBodies.lua','lib/CelestialRenderer2.lua','lib/Config.lua',
 'lib/DramalessAtmos.lua','lib/Settings.lua','lib/SnowPack.lua','lib/SnowSurfacePaint.lua','lib/Tornado.lua'
}
changed=[];bad=[]
...
for rel in sorted(allowed-set(changed)): print('FAIL required 8.1.67 change missing '+rel);bad.append(rel)
extra=[]
...
print(f'8.1.67 runtime delta changed={sorted(changed)}')
