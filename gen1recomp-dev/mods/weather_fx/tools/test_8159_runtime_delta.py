...
allowed={'lib/DramalessAtmos.lua','lib/voxel_atmos/CinematicAtmos.lua'}
changed=[];bad=[]
...
for rel in sorted(allowed-set(changed)):
    print('FAIL required 8.1.59 change missing '+rel);bad.append(rel)
print(f'8.1.59 runtime delta changed={sorted(changed)}')
