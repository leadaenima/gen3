...
base=json.loads((R/'tools/baselines/8.1.36-runtime-sha256.json').read_text())['files']
allowed={'lib/voxel_atmos/CinematicAtmos.lua'}
changed=[];bad=[]
...
print(f'8.1.37 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
