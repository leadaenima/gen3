...
base=json.loads((R/'tools/baselines/8.1.47-runtime-sha256.json').read_text())['files']
allowed={'lib/EngineRuntime.lua'}; changed=[]; bad=[]
...
print(f'8.1.48 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
