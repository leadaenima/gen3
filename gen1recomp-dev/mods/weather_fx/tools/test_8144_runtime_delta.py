...
base=json.loads((R/'tools/baselines/8.1.43-runtime-sha256.json').read_text())['files']
allowed={'lib/DramalessAtmos.lua','lib/ConnectedWater.lua','lib/voxel_atmos/ConnectedWater3D.lua'}
changed=[];bad=[]
...
print(f'8.1.44 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
