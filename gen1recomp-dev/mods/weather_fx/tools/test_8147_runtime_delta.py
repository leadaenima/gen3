...
base=json.loads((R/'tools/baselines/8.1.46-runtime-sha256.json').read_text())['files']
allowed={
 'lib/EngineRuntime.lua','lib/FlatWorldInteraction.lua','lib/GPUWeatherEngine.lua',
 'lib/LightProbeGrid.lua','lib/SurfaceVisuals.lua','lib/VolumetricWeather.lua',
...
print(f'8.1.47 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
