...
base=json.loads((R/'tools/baselines/8.1.42-runtime-sha256.json').read_text())['files']
allowed_changed={'lib/Constellations.lua'}
changed=[];bad=[]
...
print(f'8.1.43 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
