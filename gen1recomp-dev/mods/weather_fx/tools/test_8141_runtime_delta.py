...
base=json.loads((R/'tools/baselines/8.1.40-runtime-sha256.json').read_text())['files']
allowed={'lib/StormCells.lua','lib/DistantWeather.lua','lib/voxel_atmos/CinematicAtmos.lua'}
changed=[];bad=[]
...
print(f'8.1.41 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
