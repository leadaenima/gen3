...
base=json.loads((R/'tools/baselines/8.1.44-runtime-sha256.json').read_text())['files']
...
print(f'8.1.45 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
