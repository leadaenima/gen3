...
base=json.loads((R/'tools/baselines/8.1.63-runtime-sha256.json').read_text())['files']
allowed={'lib/SnowPack.lua','lib/voxel_atmos/WorldPrecip.lua'};changed=[];bad=[]
...
for rel in sorted(allowed-set(changed)): print('FAIL required 8.1.64 change missing '+rel);bad.append(rel)
print(f'8.1.64 runtime delta changed={sorted(changed)}')
