...
base=json.loads((R/'tools/baselines/8.1.31-runtime-sha256.json').read_text())['files']
...
print(f'8.1.32 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
