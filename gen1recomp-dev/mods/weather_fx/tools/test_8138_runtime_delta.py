...
base=json.loads((R/'tools/baselines/8.1.37-runtime-sha256.json').read_text())['files']
...
print(f'8.1.38 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
