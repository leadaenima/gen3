#!/usr/bin/env python3
"""Weather FX 8.1.90 full developer sweep.
...
# water / wind
'connected_water_3d_test.lua','connected_water_test.lua','professional_water_8133_test.lua','complete_water_ownership_8136_test.lua','water_hotpath_8132_test.lua','water_player_safety_8136_test.lua','water_style_8131_test.lua','wind_engine_test.lua','wind_player_test.lua',
...
PYTOOLS=['test_sunset_halo.py','test_settings_runtime.py','revision_gate.py','test_performance_invariants.py','test_3d_pipeline_integrity.py','feature_audit.py','test_voxel_host_compat.py','test_love_sandbox.py']
...
def main():
    ...
    for name,out in details:
        print(f'\n--- FAIL {name} ---\n{out}')
    print(f'\n8.1.90 developer sweep: {passed} programs passed, {failed} failed')
