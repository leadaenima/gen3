...
base=json.loads((R/'tools/baselines/8.1.38-runtime-sha256.json').read_text())['files']
allowed={'lib/ConnectedWater.lua','lib/voxel_atmos/ConnectedWater3D.lua','lib/DramalessAtmos.lua'}
changed=[];bad=[]
...
print(f'8.1.39 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
