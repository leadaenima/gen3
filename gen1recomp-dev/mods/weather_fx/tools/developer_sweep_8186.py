#!/usr/bin/env python3
"""Weather FX 8.1.86 full developer sweep.
...
def main():
    ...
    for name,out in details:
        print(f'\n--- FAIL {name} ---\n{out}')
    print(f'\n8.1.86 developer sweep: {passed} programs passed, {failed} failed')
