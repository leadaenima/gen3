...
base=json.loads((R/'tools/baselines/8.1.34-runtime-sha256.json').read_text())['files']
...
print(f'8.1.35 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
