...
base=json.loads((R/'tools/baselines/8.1.33-runtime-sha256.json').read_text())['files']
allowed={'lib/voxel_atmos/ConnectedWater3D.lua','lib/ConnectedWater.lua'}
changed=[];bad=[]
...
print(f'8.1.34 runtime preservation: changed={sorted(changed)} unexpected={sorted(set(bad))}')
