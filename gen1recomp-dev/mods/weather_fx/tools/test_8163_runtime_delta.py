...
base=json.loads((R/'tools/baselines/8.1.62-runtime-sha256.json').read_text())['files']
...
for rel in sorted(allowed-set(changed)): print('FAIL required 8.1.63 change missing '+rel);bad.append(rel)
print(f'8.1.63 runtime delta changed={sorted(changed)}')
