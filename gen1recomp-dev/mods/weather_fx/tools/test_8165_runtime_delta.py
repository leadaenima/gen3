...
base=json.loads((R/'tools/baselines/8.1.64-runtime-sha256.json').read_text())['files']
allowed={'lib/Tornado.lua','lib/voxel_atmos/Tornado3D.lua'};changed=[];bad=[]
...
for rel in sorted(allowed-set(changed)): print('FAIL required 8.1.65 change missing '+rel);bad.append(rel)
print(f'8.1.65 runtime delta changed={sorted(changed)}')
