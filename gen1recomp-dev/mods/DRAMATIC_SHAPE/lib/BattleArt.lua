...
function BattleArt.speciesFor(battler)
  -- Gen1/2 BattleState: battler.mon.species. Ruby/Game3: the mon IS the
  -- battler and carries .species at the top level (no .mon wrapper).
  local species = battler and (battler.__battleArtTransformed
                               or battler.species
                               or (battler.mon and battler.mon.species)
                               or (battler.pokemon and battler.pokemon.species)) or nil
