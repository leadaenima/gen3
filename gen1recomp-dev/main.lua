...
function bootGame(version, cartId)
  ...
  -- Gen 2 / Gen 3: Gen 1 Game:load cannot consume those caches -- different
  -- generated tables, save shape and screen size -- so Gold boots Game2 and
  -- Ruby boots Game3.  The three never branch into each other.
